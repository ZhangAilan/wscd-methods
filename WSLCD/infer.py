...
if __name__ == '__main__':
    ...
    pklname = (args.model + "-" + str(args.backbone) + "-" + str(args.out_stride) + "-" + str(args.mode) + "-" +
               args.multiscale + "-" + args.weightcls + "-" + str(args.epoch) + "-" + str(args.th) + "-" +
               str(args.ema) + "-" + str(args.dataset) + "-" + str(args.imgsize) + "-" + str(args.weight) + "-" +
               str(args.wc) + ".pth")

    accname = (args.model + "-" + str(args.backbone) + "-" + str(args.out_stride) + "-" + str(args.mode) + "-" +
               args.multiscale + "-" + args.weightcls + "-" + str(args.epoch) + "-" + str(args.th) + "-" +
               str(args.ema) + "-" + str(args.dataset) + "-" + str(args.imgsize) + "-" + str(args.weight) + "-" +
               str(args.wc) + ".csv")
    ...
    test_dataset = LoadDatasetFromFolder(suffix, test1_dir, test2_dir, label_test,
                                         img_size=args.imgsize, is_train=False)
