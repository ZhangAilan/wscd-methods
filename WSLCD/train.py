...
class BCELoss_class_weighted(nn.Module):
    def __init__(self, weight):
        super().__init__()
        # The weight of positive and negative samples in binary classification,
        # with the first term being negative class weight and the second term being positive class weight
        self.weight = weight
